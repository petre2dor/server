...
class FilesPlugin extends ServerPlugin {
	...
	public const SUBFOLDER_COUNT_PROPERTYNAME = '{http://nextcloud.org/ns}subfolders';
	public const SUBFILE_COUNT_PROPERTYNAME = '{http://nextcloud.org/ns}subfiles';
	...
	public function handleGetProperties(PropFind $propFind, \Sabre\DAV\INode $node) {
		...
		if ($node instanceof Directory) {
			...
			if (in_array(self::SUBFILE_COUNT_PROPERTYNAME, $requestProperties, true)
				|| in_array(self::SUBFILE_COUNT_PROPERTYNAME, $requestProperties, true)) {
				$nbFiles = 0;
				$nbFolders = 0;
